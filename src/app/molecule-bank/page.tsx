...
export default function MoleculeBankPage() {
  ...
  return (
    <DefaultLayout>
      <ComponetHeader pageName="Molecule Bank" containActionButton={false} />
      ...
      {compoundData && (
        <div className="mb-10 mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="dark:bg-gray-800 space-y-3 rounded-lg bg-white p-6 shadow-md">
            ...
            <p><strong className="text-gray-600 dark:text-gray-300">Molecular Formula:</strong> {compoundData.MolecularFormula}</p>
            <p><strong className="text-gray-600 dark:text-gray-300">Molecular Weight:</strong> {compoundData.MolecularWeight} g/mol</p>
            <p><strong className="text-gray-600 dark:text-gray-300">InChIKey:</strong> {compoundData.InChIKey}</p>
            <p><strong className="text-gray-600 dark:text-gray-300">Canonical SMILES:</strong> <MoleculeStructure id={`${compoundData.CanonicalSMILES}`} structure={compoundData.CanonicalSMILES} /></p>
            <p><strong className="text-gray-600 dark:text-gray-300">Isomeric SMILES:</strong> {compoundData.IsomericSMILES}</p>
            <p><strong className="text-gray-600 dark:text-gray-300">IUPAC Name:</strong> {compoundData.IUPACName}</p>
          </div>
          ...
          <div className="dark:bg-gray-800 space-y-3 rounded-lg bg-white p-6 shadow-md">
            ...
            <p><strong className="text-gray-600 dark:text-gray-300">XLogP:</strong> {compoundData.XLogP}</p>
            <p><strong className="text-gray-600 dark:text-gray-300">Exact Mass:</strong> {compoundData.ExactMass} g/mol</p>
            <p><strong className="text-gray-600 dark:text-gray-300">Monoisotopic Mass:</strong> {compoundData.MonoisotopicMass} g/mol</p>
            <p><strong className="text-gray-600 dark:text-gray-300">TPSA:</strong> {compoundData.TPSA} Å²</p>
            <p><strong className="text-gray-600 dark:text-gray-300">Complexity:</strong> {compoundData.Complexity}</p>
            <p><strong className="text-gray-600 dark:text-gray-300">Charge:</strong> {compoundData.Charge}</p>
          </div>
        </div>
      )}
